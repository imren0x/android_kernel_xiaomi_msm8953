...
headers_install: __headers
	...
	$(Q)$(MAKE) $(hdr-inst)=techpack/audio/titanium/include/uapi dst=techpack/audio/include
...
headers_check: headers_install
	...
	$(Q)$(MAKE) $(hdr-inst)=techpack/audio/titanium/include/uapi dst=techpack/audio/include HDRCHECK=1
